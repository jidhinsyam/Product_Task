                ...
                <div className="container-fluid"style={{textDecoration: 'none', padding: '50px', color: 'black'}}  >
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link  active" href="/addcategory"  style={{ listStyle: 'none', marginRight: '50px',fontFamily:'serif',fontSize:'20px' }}>
                                    Add category
                                </a>
                            </li>
                            <li className="nav-item active">
                                <a className="nav-link  active" href="/addsubcategory " style={{ listStyle: 'none', marginRight: '50px',fontFamily:'serif',fontSize:'20px' }}>
                                    Add Sub-category
                                </a>
                            </li>
                            <li className="nav-item active">
                                <a className="nav-link  active" href="/addproduct" style={{ listStyle: 'none', marginRight: '50px',fontFamily:'serif',fontSize:'20px' }}>
                                    Add Products
                                </a>
                            </li>
